...
export default connect(
	...
	(dispatch, ownProps) => {
		const postCommentSuccess = (id, articles) => dispatch({ type: "POSTCOMMENT", article_id: id, newArticle: articles})
		...
		return {
            ...
            trypostComment: (text) => postComment(ownProps.id, text, {postCommentSuccess}),
